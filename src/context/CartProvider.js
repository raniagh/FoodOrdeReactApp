...
const cartReducer = (state, action) => {
  if (action.type === "ADD") {
    ...
    //Verify if the item exist in the cart or not (if not it will return -1)
...
const CartProvider = (props) => {
  /* cartReducer is a reducer function 
    defaultCartState is an initial state value
    dipatchCartAction allows us to dipatch an action to the reducer
    */
